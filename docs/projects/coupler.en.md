...
I now lead development for a product that began as outsourced maintenance work. From 1.0.0 operation through the 2.0.0 transition, I clarified TypeScript migration criteria, signup/review flow criteria, and development/review criteria through an AI-based development workflow (AX).
...
- Applied an AI-based development workflow (AX) to cycle through problem decomposition, implementation, review, regression testing, validation, and documentation criteria.
...
- Used the AI-based development workflow (AX) to split requirements into smaller units, then iterate app/API/admin web/database changes through implementation, review, regression validation, and documentation sync.
...
Within the public scope, this page focuses on state contracts, review policies, TypeScript migration criteria, AI-based development workflow (AX), and review criteria produced while operating the product and tied back to code standards.
