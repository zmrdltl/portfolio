...
I am a Platform Software Engineer who verifies generated API responses and DB effects before deployment, fixes concurrency issues in Rust services, and ties product changes to regression tests and release criteria.
...
- Backend/Data: GraphQL, WebSocket, MySQL, Tibero
