...
At ClumL, I currently work on detection/report data correctness, Rust service test stability, issue/spec writing, and PR review in a security event analysis product suite. I present this as a current product correctness and regression-control case.
