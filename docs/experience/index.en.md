...
| --- | --- | --- |
| Mar 2025 - Jul 2026 · [ClumL](cluml.md) | Rust backend fixes, external configuration for a network-event detection threshold, and regression verification | Fixed over-limit request passing · reduced the operational change time for one recurring setting adjustment by at least 30% |
