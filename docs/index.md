...
- [제품 상태 계약과 운영 기준](projects/coupler.md): React Native app, API, 관리자 웹, DB, 정책 문서가 같은 가입·심사 상태 모델을 따르도록 정리했습니다. TypeScript 운영 기준, typecheck/migration guard, 회귀 검증, 코드 리뷰 기준을 제품 변경 기준으로 연결했습니다.
