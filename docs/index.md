...
- [보안 분석 제품의 표시 일관성과 변경 안전성](experience/cluml.md): 탐지 목록/상세, time range, port/packet, chart/report가 같은 이벤트 맥락을 유지하도록 수정하고 GitHub issue와 PR review 기준으로 변경 범위를 확인하고 있습니다.
...
- Review system: GitHub issue 기반 작업 정의, 완료 기준, test coverage, change-safety review, AI-assisted development 검증 기준
